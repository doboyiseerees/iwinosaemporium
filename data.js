...
const inventory = [
    {
        ...
        name: "Mercedes Vodka",
        price: 120.00,
        image: "/images/wine17.jpg", // You'll need real images later
    ...
    // ... Copy paste this block 17 more times with different names/IDs!
    {
    id: "wine_014",
    category: "wine",
...
},
{
...

    {
        ...
        image: "https://upload.wikimedia.org/wikipedia/commons/8/8d/President_Barack_Obama.jpg", // Direct link to a reliable image
        ...
        reviews: [] // Not needed for people, but keeps the object structure consistent
    },
    {
        id: "mov_002",
        category: "motivation",
        ...
        image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRBOrFVTYGM4CE4US3tTOIozgIRldMoS7DPzQ&s", // Placeholder for Dr. Enabulele
        ...
        history: "A proud graduate of the University of Benin (UNIBEN). He rose through the ranks of the Nigerian Medical Association to become the first Nigerian to head the World Medical Association, proving that excellence knows no borders.",
        reviews: []
    },
    ...
    },
    {
        ...
        summary: "Mcity etallic bronze cylindrical beads with a heavy, industrial luxury weight.",
